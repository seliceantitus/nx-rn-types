          ...
          <View style={styles.section}>
            <View style={styles.shadowBox}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  Linking.openURL('https://cloud.nx.app/connect/nrMMnRcRyc');
                }}
              >
                <Text
                  style={[
          ...
          >
            <View style={styles.shadowBox}>
              ...
              <View style={styles.codeBlock}>
                ...
                >
                  nx test CommunicationApp
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Lint
                </Text>
                <Text style={[styles.textXS, styles.monospace]}>
                  nx lint CommunicationApp
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Run them together!
                </Text>
                ...
                >
                  nx run-many -p CommunicationApp -t build test lint
                </Text>
              </View>
              ...
              <View style={[styles.codeBlock, styles.marginBottomLg]}>
                <Text style={[styles.textXS, styles.monospace]}>
                  nx show project CommunicationApp
                </Text>
              </View>
              <View style={styles.listItem}>
                <Svg
