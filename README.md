...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/w5J0oTn57O)
...
```sh
npx nx serve communication-app
```

To create a production bundle:

```sh
npx nx build communication-app
```

To see all available targets to run for a project, run:

```sh
npx nx show project communication-app
```
